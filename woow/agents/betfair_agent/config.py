...
@dataclass
class AgentConfig:
    mode: str = os.getenv("AGENT_MODE", "SIM")  # SIM or REAL
    ...
    bf_certs_dir: str = os.getenv("BF_CERTS_DIR", "")  # directory containing client cert & key
    # Strategy params
    ...
    event_type_ids: str = os.getenv("EVENT_TYPE_IDS", "2")  # Tennis=2
